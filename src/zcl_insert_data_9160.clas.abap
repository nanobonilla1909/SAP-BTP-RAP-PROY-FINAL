CLASS zcl_insert_data_9160 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_INSERT_DATA_9160 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA: lt_orders TYPE TABLE OF zorders_9160.
    DATA: lt_items TYPE TABLE OF zitems_9160.
...
** ORDERS **
    lt_orders = VALUE #(
        ...
        ( order_id = 'GW2TB-06' email = 'feli78@gmail.com' first_name  = 'Felicitas' last_name = 'Perez' country = 'Uruguay' delivery_date = '20250613'
          order_status = 'T' image_url = '' created_on = '20241109235438.0000000' last_changed_at  = '20241109235438.0000000' )
    ).

    DELETE FROM zorders_9160.
    INSERT zorders_9160 FROM TABLE @lt_orders.
    SELECT * FROM zorders_9160 INTO TABLE
    @lt_orders.
    out->write( sy-dbcnt ).
...
** ITEMS **
    ...
    DELETE FROM zitems_9160.
    INSERT zitems_9160 FROM TABLE @lt_items.
    SELECT * FROM zitems_9160 INTO TABLE
    @lt_items.
    out->write( sy-dbcnt ).
